"""
DQAS Classification Experiment.

Trains a Differentiable Quantum Architecture Search circuit on a
synthetic classification task, demonstrating automatic discovery of
circuit architectures via bi-level optimization.

Usage:
    python -m experiments.classification [--n_qubits 4] [--n_layers 3]
"""
...
def main():
    parser = argparse.ArgumentParser(description="DQAS Classification Experiment")
    ...
    print("=" * 60)
    print("DQAS: Classification Experiment")
    print("=" * 60)
    ...
    summary = {
        ...
        "results": {
            ...
            "test_loss_rounded": round(results["test_loss"], 6),
        },
    ...
    out_path = os.path.join(config.results_dir, "classification_result.json")
